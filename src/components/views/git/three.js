...
export default class Three extends Component {
  render() {
    return(
      <div className="card">
        <a href="https://leadcityfashion.com.ng/" 
          target="_blank"
          rel="noopener noreferrer" alt="https://leadcityfashion.com.ng/"><h4>Lead City Fashion & Lifestyle Academy <i class="em em-link"></i></h4></a>
