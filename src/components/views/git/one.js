...
export default class One extends Component {
  render() {
    return(
      <div className="card">
        <a href="https://github.com/Usheninte/react-fcctest" 
          target="_blank"
          rel="noopener noreferrer" alt="https://github.com/Usheninte/react-fcctest"><h4>react-fcctest Plugin <i class="em em-link"></i></h4></a>
