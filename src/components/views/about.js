  ...
  render() {
    return(
      <div>
        ...
        <img style={round} src={'https://res.cloudinary.com/poetrique/image/upload/c_scale,h_500,w_500/v1543688520/miscellaneous/placeholder.png'} alt="Coder" title="Coder Profile" />
